var ArcballCamera = function(center, zoomSpeed, screenDims) {
	...
	var vt = vec3.set(vec3.create(), 0, 0, -5.0); //-5 is distance: distant object has less relative perspective distortion
	//console.log(vt);
...
ArcballCamera.prototype.rotateY = function(curMouse) {
